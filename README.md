...
[renderer SDK guide](docs/renderer-sdk.md). The .NET 8 P/Invoke layer,
optional Silk.NET host-window adapter, NativeAOT publish path and three C#
examples are covered by the [C# binding guide](docs/csharp-binding.md).
