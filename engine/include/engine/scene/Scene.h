...
// Both the legacy combined MRAO map and standard glTF texture slots are
// supported; color textures are sRGB while material data textures are linear.
struct Material
{
    ...
    // Legacy combined convention used by the procedural sandbox:
